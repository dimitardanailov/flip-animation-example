package filipanimation.exampleflipanimation.fragments.googlemaps;
...
import filipanimation.exampleflipanimation.fragments.googlemaps.widgets.CustomGoogleMapFragment;

/**
 * Created by Dimitar Danailov on 10/14/15.
 * email: dimityr.danailov@gmail.com
 */
public class ApplicationMapFragment extends BaseFragment implements OnMapReadyCallback {

    // Get class name
    private static final String TAG = ApplicationMapFragment.class.getName();
     ...
     *
     * We change zoom from 1 to {@link ApplicationMapFragment#DEFAULT_ZOOM_LEVEL}.
     *
     * @param map
     */
